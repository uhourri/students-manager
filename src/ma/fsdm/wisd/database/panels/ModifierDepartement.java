...
public class ModifierDepartement extends JPanel {
	private static final long serialVersionUID = 7617603329912555083L;
	
	//private JPanel contentPane;
	private JTextField textNom;
	private JTextField textCode;

	public ModifierDepartement() throws Exception {
		...
		JLabel selectionerLabel = new JLabel("Departement à modifier :");
		...
		editButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(!nom.isEmpty()) {
						metier.modifierDepartement(code, nom);
						resetButton.doClick();
					}
				} catch (Exception e1) {
					e1.printStackTrace();
