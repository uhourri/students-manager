...
public class SupprimerEtudiant extends JPanel {
	...
	public SupprimerEtudiant() throws Exception {
		...
		JLabel selectionerLabel = new JLabel("\u00C9tudiant \u00E0 supprimer :");
